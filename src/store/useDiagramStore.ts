...
import { canSwapShapeKind, isAnchorNode, isContainerNode, isFrameNode, isGroupNode, isInkNode } from '../lib/nodeKinds';
import {
  absolutePosition,
  boundsOf,
  innermostContaining,
...
export const useDiagramStore = create<DiagramState>((set, get) => ({
  ...
  loadDiagram: (id, title, starred, data, updatedAt, options) => {
    ...
    // never stored (see `deriveMindMapHidden`).
    const opened = deriveMindMapHidden(
      normalizeParentage(migrated.nodes as unknown as ShapeNode[]),
